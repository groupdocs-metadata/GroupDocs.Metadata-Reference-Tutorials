...
請參閱 [documentation](https://docs.groupdocs.com/metadata/java/) 與 [GitHub repository](https://github.com/groupdocs-metadata/GroupDocs.Metadata-for-Java) 取得完整指南與範例。
