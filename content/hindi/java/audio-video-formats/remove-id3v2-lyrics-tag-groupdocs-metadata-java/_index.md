...
## हाजिर जवाब
- **कौन सी लाइब्रेरी इस्तेमाल की जाती है?** GroupDocs.Metadata for Java
- **कौन सा टैग हटाया जाता है?** ID3v2 लिरिक्स टैग (`USLT`)
- **क्या मुझे लाइसेंस चाहिए?** टेस्ट के लिए एक फ्री ट्रायल या टेम्पररी लाइसेंस काफी है
- **क्या ऑडियो बदल जाएगा?** नहीं, सिर्फ मेटाडेटा बदला जाता है
- **क्या मैं कई वर्जन को प्रोसेस कर सकता हूँ?** हाँ, API बल्क ऑपरेशन्स पर इफेक्टिव तरीके से काम करता है

## “how to clean mp3” क्या है?
MP3 को क्लियर करना मतलब उसके मेटाडेटा टैग्स—जैसे टाइटल, आर्टिस्ट, एल्बम, या लिरिक्स—को एडिट या हटाना है, ताकि फाइल में सिर्फ वही जानकारी रहे जो आप चाहते हैं। लिरिक्स टैग हटाना एक आम सफाई का काम है जब आप कॉपीराइटेड टेक्स्ट की सेफ्टी करना चाहते हैं या सिर्फ टैग की लिफ्टिंग कम करना चाहते हैं।

## GroupDocs.Metadata से ID3v2 लिरिक्स टैग क्यों हटाएं?

- **तेज़ और मेमोरी‑कुशल** – लाइब्रेरी स्ट्रीम्स के साथ काम करती है और पूरे ऑडियो को मेमोरी में लोड नहीं करती।

- **क्रॉस‑फॉर्मेट सपोर्ट** – MP3 के अलावा, आप कई दूसरे मीडिया फ़ाइलों के टैग्स को मैनेज कर सकते हैं।

- **सरल API** – फ़ाइल को लोड, एडिट और सेव करने के लिए कुछ ही फ़ाइलों का Java कोड काफ़ी है।

## ज़रूरी शर्तें
- Java 8+ डेवलपमेंट पर्यावरण
- Maven (या मैपी JAR जोड़ने की क्षमता)
...
### स्टेप 1: मेटाडेटा क्लास का इस्तेमाल करके MP3 फ़ाइल लोड करें
यह स्टेप दिखाता है कि **मेटाडेटा के साथ MP3 कैसे लोड करें** ताकि आप इसके टैग एडिट कर सकें।
...
### स्टेप 2: MP3 फ़ाइल का रूट पैकेज लें
रूट पैकेज ID3v2 फ़्रेम तक डायरेक्ट एक्सेस देता है।
...
### स्टेप 3: लिरिक्स टैग को Null पर सेट करें
यहाँ MP3 से लिरिक्स हटाने का तरीका बताया गया है।
...
### स्टेप 4: मॉडिफाइड MP3 फ़ाइल सेव करें
बदलावों को एक नई फ़ाइल में कमिट करें ताकि ओरिजिनल फ़ाइल में कोई बदलाव न हो।
